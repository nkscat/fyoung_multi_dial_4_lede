...
# type 1. In another word, I dual 4 times daily. The reason why it is 
# not 6 times is that the time of each account is limited by chinanet. 
# Hope you've got it.                   
#                          Config Files.                             
...
# and 3 of online_option 1 turn to use.#! /bin/bash
########################################################################
#                   Varibales you need to input.                      
#                          All accounts.   
#                    One account can dual twice.                             
